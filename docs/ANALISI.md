...
> **Scostamento assorbito in fase 4b — l'astrazione ora c'è.** In fase 4 non era stata scritta, e la ragione era dichiarata: un'interfaccia con una sola implementazione non ha modo di essere sbagliata nel punto giusto, e si scopre quale sia il confine utile solo scrivendo la seconda. La seconda e stata scritta il 2026-08-07 e il confine e `assets/js/catageo-mappa-api.js`. **Il risultato non coincide con l'elenco di metodi ipotizzato qui sopra**, ed e il motivo per cui aspettare e servito: quei metodi non prevedevano ne la proiezione in coordinate schermo — indispensabile al raggruppamento, che lavora su una griglia di pixel — ne il riquadro della vista, ne il test di contenimento. Senza, ogni provider avrebbe dovuto riscrivere il clustering, che e la parte piu delicata. Il contratto effettivo e documentato in testa a quel file.
...
**Gli ipogei archeologici hanno un segno ciascuno.** Catacomba, chiesa rupestre, ipogeo funerario, mitreo ed eremo stanno tutti sotto «insediamenti e opere di culto»: ereditando dalla madre finirebbero in mappa come lo stesso identico punto, e sono invece cinque cose che un archeologo non confonderebbe mai. Sono l'arcosolio, il portale con la croce nel timpano, il tumulo con dromos e camera, la sezione con i due podi, la guglia con la cella. La prova non verifica che «esistano»: verifica che siano **cinque simboli diversi**, perche cinque simboli uguali sarebbero un difetto che nessun controllo di esistenza vedrebbe.

**Le naturali non usano piu simboli meteorologici.** Per marina, tettonica, glaciale e di erosione si prendevano in prestito da Bootstrap l'onda anomala, il tracciato sismico, il fiocco di neve e il vento: descrivono il fenomeno che sta fuori, non la cavita che quel fenomeno ha scavato. Ora sono l'arco nella falesia sul mare, la frattura fra due blocchi, la bocca di ghiaccio con le stalattiti, il vuoto lenticolare fra due banchi.

**Ogni voce della tassonomia consegnata ha un segno proprio.** L'ereditarieta esiste ancora, e serve alle voci che un catasto aggiunge da se: quelle compaiono in mappa con il simbolo della madre senza che chi le crea debba scegliere. Ma il vocabolario che l'applicativo consegna non ne ha bisogno, e nove voci che ereditavano erano un difetto e non un risparmio: una scheda «Passaggio di collegamento» compariva come una galleria qualunque. Quarantanove voci, quarantanove segni. La prova lo verifica **sull'attributo** e non sul valore risolto: risolvendo, una voce senza icona prende quella della madre e il controllo passerebbe sempre — e la differenza fra «in mappa si vede qualcosa» e «in mappa si vede questa cosa». Dove due voci condividono un glifo e perche la sottotipologia **e** l'archetipo della categoria («Galleria stradale» dentro «Opere di transito»), e inventarne uno diverso avrebbe prodotto due simboli che dicono la stessa cosa.

**Il glifo deve riempire la pastiglia.** Con `0.82rem` dentro 30 px restava un anello d'aria largo quanto il simbolo, e a distanza d'occhio si leggeva solo il colore: uno dei due canali su due, cioe meta del sistema buttata. La pastiglia e ora 34 px e il glifo 1,45rem. La regola vale per **entrambe le provenienze** — il font di Bootstrap e i nostri `<svg>` — perche un `<svg>` senza misura esplicita eredita quella del testo della pagina, che in mappa non e la stessa. La leggibilita si giudica guardando, ma la misura si controlla, e senza controllo chi ritocca il foglio di stile rimpicciolisce il glifo senza accorgersene.

**Il pieno e il contorno dicono cose diverse.** Il progetto era partito da «forme piene sempre», che e giusto per la roccia e sbagliato per tutto cio che e vuoto: una neviera e un guscio di muratura riempito di neve, una camera di degassamento e un vuoto isolato, una bocca di grotta glaciale e un'apertura. Disegnati pieni dicevano «collina», «palla», «masso». La regola e: **pieno per la massa, contorno per il vuoto costruito e per la bocca**, e mai un tratto piu sottile di un'unita su sedici, che a 22 px sparirebbe.

**L'acqua e sempre una linea ondulata.** In un condotto l'acqua scorre, e una massa piatta sul fondo dice «allagato», che e un'altra cosa. Il mare aperto si disegna a tratti **interrotti e sfalsati**: righe continue che attraversano tutto il riquadro sono la corrente di un fiume.

**Le geometrie ripetitive si calcolano, non si scrivono.** La corona di mattoni del pozzo e fatta di ventidue quadrilateri in coordinate polari: a mano sarebbero venuti storti, e con le fughe tutte uguali il glifo sembrava una tavolozza di colori. Gli scostamenti che li rendono irregolari vengono da una tabella fissa e non da un numero casuale, cosi il file rigenerato e identico e la differenza in git resta leggibile. Lo stesso vale per il fiocco di neve: un braccio definito una volta e ruotato sei volte, invece di trentasei tracciati da correggere in trentasei punti.

**Un glifo si giudica solo guardandolo.** Dodici dei trentadue sono stati ridisegnati dopo che chi li usa li ha visti, e tutti e dodici erano sbagliati per la stessa ragione: dicevano la cosa giusta a chi li aveva disegnati e un'altra a chi li guardava. L'arco a tutto sesto sotto la montagna diceva «galleria artificiale»; il pozzo in sezione era un tavolo; due podi dentro una volta non dicevano «mitreo» a nessuno. Nessuna prova poteva trovarlo — le verifiche dicono che un simbolo esiste, che e distinto e che il vocabolario non punta al vuoto — e per questo esiste una pagina che serve i glifi a 180, 64 e 30 px: perche il giudizio si possa dare in fretta, e su tutti insieme.

**Attenzione a evenodd quando due forme si incrociano.** Con `fill-rule="evenodd"` due rettangoli sovrapposti si annullano dove si intersecano: una croce fatta di due barre esce **spezzata al centro**, e un fiocco di neve fatto di tre barre incrociate diventa una stella bucata. E capitato due volte. La regola e disegnare quelle forme come un **poligono unico** (la croce) oppure con i bracci attaccati al fusto **senza sovrapporsi** (il fiocco).

**Masse piene, con una eccezione dichiarata.** La spirale dell'abisso e l'unico glifo disegnato con un tratto invece che con una massa, perche una spirale e una linea per natura: la si rende leggibile ispessendola, non riempiendola. La prova impone allora un minimo allo spessore — nessun tracciato sotto un'unita su sedici — cosi la deroga resta una e non diventa un'abitudine.

**I commenti restano nel file e non vanno in pagina.** Lo sprite e commentato riga per riga: ogni glifo dice perche e disegnato cosi, ed e roba per chi aprira il file fra dieci anni. Passati i trenta simboli quei commenti sono meta del peso, e su una pagina sono peso per tutti e utilita per nessuno, visto che il file e li da leggere. `Icone::sprite()` li toglie in uscita e non tocca altro: nessuna riscrittura dei tracciati, perche un ottimizzatore che sbaglia un arco produce un glifo storto che nessuna prova vede. Diciotto kilobyte sul disco, poco meno di dieci in pagina.
